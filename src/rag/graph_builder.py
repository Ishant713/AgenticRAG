...
def query_classifier(state: State):
    ...
    try:
        ...
        print("docs received from retriever")
        print(context)
    except Exception as e:
        print(f"Retriever not available, routing to general: {e}")
        return {"messages": state["messages"], "route": "general", "latest_query": question}
