...
def enhance_description_with_llm(user_description: str) -> str:
    ...
    try:
        ...
        # If the LLM fails (e.g., missing API key), fall back to the original description
        import logging
        logging.getLogger(__name__).warning(f"LLM enhancement failed: {e}. Using original description.")
